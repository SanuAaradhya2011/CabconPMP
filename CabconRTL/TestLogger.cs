    ...
    public class TestLogger
    {
        ...
        public void ExecuteTestLogger(int runID)
        {
            ...
            try
            {
                ...
                if (drFailMeters.Length > 0)
                {
                    ...
                    System.Windows.Forms.MessageBox.Show("\n" + metersList, "Cabcon RTL", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Warning);
                }
        ...
        public static void WriteTextLog(string msg)
        {
            try
            {
                ...
                using (StreamWriter w = File.AppendText("CabconRTLlog.txt"))
                {
                    LogToFile(msg, w);
                }
            }
