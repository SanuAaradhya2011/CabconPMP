    ...
    public partial class frmRecordHistory : Form
    {
        ...
        private void OpenHistoryItem()
        {
            if (dgvRecordHistory.DataSource != null && dgvRecordHistory.SelectedRows.Count == 1)
            {
                ...
                if (tableextinfo == null) { MessageBox.Show("Unable to Load Data!", "L+G PMP", MessageBoxButtons.OK, MessageBoxIcon.Information); return; }
        ...
        public void LoadHistoryDataToGrid()
        {
            ...
            if (historyTable == null) { MessageBox.Show("Unable to Load Data!", "L+G PMP", MessageBoxButtons.OK, MessageBoxIcon.Information); return; }
