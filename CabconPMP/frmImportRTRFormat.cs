...
namespace CabconPMP
{
    public partial class frmImportRTRFormat : Form
    {
        ...
        private void btnBrowse_Click(object sender, EventArgs e)
        {
               try
                {
                    if (MessageBox.Show("Do You Want To Import Routine Test Report Refrence File Format For Meter Type : "  + cmbMeterType.Text , "Cabcon PMP", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.No) return;
                    ...
                    MessageBox.Show("Routine Test Report Refrence File Format Imported !", "Cabcon PMP", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    this.Close();
               }
                catch (Exception ex)
                {
