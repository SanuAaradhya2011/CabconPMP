...
namespace CabconPMP
{
    public partial class frmMeterRange : Form
    {
        ...
        private void frmMeterRange_Load(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(Ex.ToString(), "Cabcon PMP", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1);
        ...
        private void btnBrowse_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                      MessageBox.Show("Please Select A Valid Meter Type !", "Cabcon PMP", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                      return;
                }
                ...
                {
                    int msgindex =Convert.ToInt16(MessageBox.Show("Do You Want To Upload Selected File ?", "Cabcon PMP", MessageBoxButtons.YesNo, MessageBoxIcon.Warning));
                    ...
                    MessageBox.Show("Meter ID List Saved !", "Cabcon PMP", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    this.Close();
            ...
            {
                MessageBox.Show("Invalid File Selected or No Data To Save !" + "\n\n" + Ex.ToString(), "Cabcon PMP", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1);
