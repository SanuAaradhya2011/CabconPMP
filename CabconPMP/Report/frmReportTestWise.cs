    ...
    public partial class frmReportTestWise : Form
    {
        ...
        private void lblFind_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("Plase Provide Valid Input For range Prefix !", "Cabcon PMP", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    txtFixString.Focus();
                    return;
                }
                ...
                {
                    MessageBox.Show("Plase Select a Valid Search Type !", "Cabcon PMP", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    cmbSearchBy.Focus();
                    return;
                }
                if (ds != null)
        ...
        private System.Data.DataSet GetDataByDateRange()
        {
            ...
            {
                MessageBox.Show(ex.Message, "Cabcon PMP", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                return null;
            }
        }
