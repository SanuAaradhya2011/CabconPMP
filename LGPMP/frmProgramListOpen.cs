        ...
        private void btnopen_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (lstProgramName.SelectedIndex >= 0)
                {
                    ...
                    if (MessageBox.Show("Do You Want To open Selected Program Details ?? ", "L+G PMP", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.No) return;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                if (lstProgramName.SelectedIndex >= 0)
                {
                    ...
                    if (MessageBox.Show("Do You Want To Delete Selected Program ?? ", "L+G PMP", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.No) return;
                    ...
                    MessageBox.Show("Selected Program Deleted !", "L+G PMP", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
            catch (Exception Ex)
            {
