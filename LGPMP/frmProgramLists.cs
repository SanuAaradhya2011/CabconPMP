...
namespace CabconPMP
{
    public partial class frmProgramLists : Form
    {
        ...
        private void lblDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                if (MessageBox.Show("Do You Want To Delete Selected Parameter ?? ", "L+G PMP", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.No) return;
        ...
        private void AddParameterDetails()
        {
            ...
            {
                MessageBox.Show("Please Enter Valid Program Name !", "L+G PMP", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            if (txtParametersName.Text.Trim().Length <= 2)
            {
                MessageBox.Show("Please Enter Valid Parameter Name !", "L+G PMP", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            {
                MessageBox.Show("Parameter Name Already Exist !", "L+G PMP", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
        }
        ...
        private void lblSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (MessageBox.Show("Do You Want To Save the Program Details ?? ", "L+G PMP", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.No) return;
                Application.DoEvents();
                this.Cursor = Cursors.WaitCursor;
                string resultmsg = string.Empty;
                if (txtProgramName.Text.Trim().Length <= 2)
                {
                    MessageBox.Show("Please Enter Valid Program Name !", "L+G PMP", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                    return;
                }
                if (lstParameterLists.Items.Count <= 0)
                {
                    MessageBox.Show("Please Add Valid Program Name !", "L+G PMP", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                    Application.DoEvents();
                    return;
                }
                ...
                MessageBox.Show("Program Details Saved !", "L+G PMP", MessageBoxButtons.OK, MessageBoxIcon.Information);
